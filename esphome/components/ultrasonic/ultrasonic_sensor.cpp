// dw 31/12/2025 add more debugging
...
void UltrasonicSensorComponent::loop() {
  ...
  if (this->store_.echo_end) {
    unit32_t pulse_startup = this->store_.measurement_start_us - this->store_.echo_start_us;
    ESP_LOGV(TAG, "Echo was delayed by %" PRIu32 "us", pulse_startup);	
